CLASS zcl_lam_sr_data_manager DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_LAM_SR_DATA_MANAGER IMPLEMENTATION.
...
*        output =
  ...
  METHOD fill_master_data.
    data : lt_bp type table of zlam_sr_bpa,
           lt_prod type table of zlam_sr_product.
   ...
   append value #(
    ...
    append value #(
     ...
     insert zlam_sr_bpa from table @lt_bp.
     insert zlam_sr_product from table @lt_prod.
  ENDMETHOD.
  ...
  METHOD fill_transaction_data.
    data : o_rand type REF TO cl_abap_random_int,
           ...
           lv_ord_id type zlam_sr_dte_id,
           lt_so type table of zlam_sr_so_hdr,
           lt_so_i type table of zlam_sr_so_item.
    ...
    select * from zlam_sr_bpa into table @data(lt_bpa).
    select * from zlam_sr_product into table @data(lt_prod).
    ...
    insert zlam_sr_so_hdr from table @lt_so.
    insert zlam_sr_so_item from table @lt_so_i.

  ENDMETHOD.


  METHOD flush.
    delete from : zlam_sr_bpa, zlam_sr_product, zlam_sr_so_hdr, zlam_sr_so_item.
  ENDMETHOD.
ENDCLASS.
