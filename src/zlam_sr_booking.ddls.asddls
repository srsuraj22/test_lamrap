...
define view entity ZLAM_SR_BOOKING as select from /dmo/booking_m
composition[0..*] of ZLAM_SR_BOOKSUPPL as _BookingSupplement
association to parent ZLAM_SR_TRAVEL as _Travel on
