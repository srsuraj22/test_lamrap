...
@EndUserText.label: 'Last child of node Booking supplement'
...
define view entity ZLAM_SR_BOOKSUPPL as select from /dmo/booksuppl_m
association to parent ZLAM_SR_BOOKING as _Booking on
    $projection.BookingId = _Booking.BookingId and
    $projection.TravelId = _Booking.TravelId
association[1..1] to ZLAM_SR_TRAVEL as _Travel on
